...
#'
#' @export
causal_iv_forest <- function(X, Y, W, Z,
                                Y.hat = NULL,
                                W.hat = NULL,
                                Z.hat = NULL,
                                num.trees = 2000,
  ...
  if (is.null(W.hat)) {
    forest.W <- do.call(grf::regression_forest, c(Y = list(W), args.orthog))
  ...
  if (is.null(Z.hat)) {
    forest.Z <- do.call(grf::regression_forest, c(Y = list(Z), args.orthog))
...
#' @export
predict.causal_iv_forest <- function(object, newdata = NULL,
                                        num.threads = NULL,
